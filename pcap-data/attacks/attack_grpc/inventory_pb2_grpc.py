...
class InventoryServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.CheckStock = channel.unary_unary(
                '/com.dissertation.inventory.InventoryService/CheckStock',
...
def add_InventoryServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.dissertation.inventory.InventoryService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('com.dissertation.inventory.InventoryService', rpc_method_handlers)
